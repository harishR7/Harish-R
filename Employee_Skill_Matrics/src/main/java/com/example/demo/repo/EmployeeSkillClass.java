...
public class EmployeeSkillClass implements EmployeeSkillRepo {
	...
	public int empSkillAdd(EmployeeSkills entity) {
		...
		String sql="insert into hr1_emp_skill(emp_id,emp_skill_id,skill_name,skill_experience,status,created_date,modified_date,skill_id) values(?,?,?,?,?,?,?,?)";
		return  template.update(sql,entity.getEmpId(),entity.getEmpSkillId(),entity.getSkillName(),entity.getSkillExperience(),entity.getStatus(),entity.getCreatedDate(),entity.getModifiedDate(),entity.getSkillId());
	}
